...
static main(void) {
	...
	FindAddress("PHYSICS_STATE_PHYSICS_AIR::Handle", "48 8B C4 48 89 58 08 48 89 78 10 55 48 8D A8 ?? ?? ?? ?? 48 81 EC ?? ?? ?? ?? 0F 29 70 E8 48 8B D9 0F 29 78 D8 44 0F 29 40 ?? 44 0F 29 48 ?? 44 0F 29 50 ?? 44 0F 29 58 ?? 44 0F 29 60 ?? 48 8B 41 08 F3 44 0F 10 A0 ?? ?? ?? ??");
	FindAddress("PHYSICS_STATE_PHYSICS_GROUND::Handle", "48 8B C4 41 55 41 56 41 57 48 81 EC ?? ?? ?? ?? 80 B9 ?? ?? ?? ?? ?? 4C 8B F1 4C 8B 69 08 48 89 58 08 48 89 78 20 48 8D 79 08");
